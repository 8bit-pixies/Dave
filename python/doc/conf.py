# -*- coding: utf-8 -*-
#
# Dave documentation build configuration file, created by
...
project = u'Dave'
copyright = u'2016, Chapman Siu'
author = u'Chapman Siu'
...
latex_documents = [
  (master_doc, 'Dave.tex', u'Dave Documentation',
   u'Chapman Siu', 'manual'),
]
...
man_pages = [
    (master_doc, 'dave', u'Dave Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Dave', u'Dave Documentation',
   author, 'Dave', 'One line description of project.',
   'Miscellaneous'),
]
